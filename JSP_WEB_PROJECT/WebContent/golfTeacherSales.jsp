        ...
        <table class="table-bordered  w-75 mx-auto ">
          <thead >
            <tr class="fs-4">
              ...
              <th class="fw-bold" scope="col">총매출</th>
            </tr>
          </thead>
          <tbody>
            <c:forEach var="sales" items="${teacherSales}">
            	<tr class="fs-4">
	            	<td class="py-1">${sales.teacherCode}</td>
	            	<td>${sales.className}</td>
	            	<td>${sales.teacherName}</td>
	            	<td>\<span class="price">${sales.tuition}<span></td>
            	</tr>
            </c:forEach>
          </tbody>
        </table>
