...
<body class="d-flex flex-column justify-content-between vh-100">
	...
	<section class="col p-5">
		...
		<div class="p-4 mx-auto w-50">
			<form id="joinForm" action="${pageContext.request.contextPath}/shop/modify.do"
				method="post">
				<table class="table table-bordered p-4 font-weight-bold">
					<tr>
						<td class="w-50 text-center">회원번호</td>
						<td class="w-50">
							<input type="hidden" name="thisMemberNo" value="${thisMember.memberNum}">
							<input type="text" name="memberNo" value="${thisMember.memberNum}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원성명</td>
						<td><input type="text" name="memberName" value="${thisMember.memberName}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원전화</td>
						<td><input type="text" name="phone" value="${thisMember.phone}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원주소</td>
						<td><input type="text" name="address" value="${thisMember.address}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">가입일자</td>
						<td><input type="text" name="joinDate" value="${thisMember.joinDate}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">고객등급(A:VIP, B:일반, C:직원)</td>
						<td><input type="text" name="grade" value="${thisMember.grade}"></td>
					</tr>
					<tr>
