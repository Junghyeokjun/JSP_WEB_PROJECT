...
<body class="d-flex flex-column justify-content-between vh-100">
	<header>
      ...
      <div class="container-fluid">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/shop/index.do">열심히하조</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-disabled="true" href="${pageContext.request.contextPath}/shop/index.do">홈쇼핑</a>
            </li>
            <li class="nav-item">
	...
	<section class="col p-5">
		...
		<div class="p-4 mx-auto w-50">
			<form id="joinForm"
				action="${pageContext.request.contextPath}/shop/modify.do"
				method="post">
				<table class="table table-bordered p-4 font-weight-bold">
					<tr>
						<td class="w-50 text-center">회원번호</td>
						<td class="w-50"><input type="hidden" name="thisMemberNo"
							value="${thisMember.memberNum}"> <input type="text"
							name="memberNo" value="${thisMember.memberNum}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원성명</td>
						<td><input type="text" name="memberName"
							value="${thisMember.memberName}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원전화</td>
						<td><input type="text" name="phone"
							value="${thisMember.phone}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">회원주소</td>
						<td><input type="text" name="address"
							value="${thisMember.address}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">가입일자</td>
						<td><input type="text" name="joinDate"
							value="${thisMember.joinDate}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">고객등급(A:VIP, B:일반, C:직원)</td>
						<td><input type="text" name="grade"
							value="${thisMember.grade}"></td>
					</tr>
					<tr>
						<td class="w-50 text-center">도시코드</td>
						<td><input type="text" name="city" value="${thisMember.city}"></td>
					</tr>
					<tr>
						<td colspan="2" class="text-center"><input type="submit"
							value="수정"> <input type="button" value="조회"
	...
	<footer class="text-center">
		<div class="d-flex justify-content-evenly align-items-center"
			...
			<div class="col-2"></div>
			<div class="col">
				<p class="m-0">HRDKOREA Copyright©2016 All rights reserved.
